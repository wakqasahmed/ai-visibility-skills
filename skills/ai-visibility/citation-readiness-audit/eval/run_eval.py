#!/usr/bin/env python3
"""Deterministic contract layer for the citation-readiness-audit skill.
...
plausible citation-readiness audit input plus the compliant output a
...
def run_should_use_fixture(fixture_dir: Path, meta: dict) -> list:
    audit_text = (fixture_dir / "golden_audit.md").read_text()
