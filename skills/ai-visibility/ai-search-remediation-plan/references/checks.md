...
- International SEO / hreflang fixes → `international-seo-hreflang-audit/references/checks.md`
- Developer docs & API fixes → `docs-api-visibility-audit/references/checks.md`
- Paywall & subscription content fixes → `paywall-access-audit/references/checks.md`
