...
11. **Produce Consolidated Deliverable**: Generate the executive 30-second dashboard, understand matrix, prioritized action plan (P0-P3), and technical appendix using [`references/templates/AUDIT_REPORT_TEMPLATE_V3.md`](references/templates/AUDIT_REPORT_TEMPLATE_V3.md).
...
Reports follow the V3 template in [`references/templates/AUDIT_REPORT_TEMPLATE_V3.md`](references/templates/AUDIT_REPORT_TEMPLATE_V3.md), scored per [`references/scoring_rubric.md`](references/scoring_rubric.md):
