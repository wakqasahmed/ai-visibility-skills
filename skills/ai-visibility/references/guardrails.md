...
Cross-cutting rules that apply across the ai-visibility skill pack. Individual skills link
here instead of restating these rules, so wording stays consistent as skills are edited
independently. Skill-specific guardrails stay inline in each `SKILL.md`.
