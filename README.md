...
| [`docs-api-visibility-audit`](skills/ai-visibility/docs-api-visibility-audit/SKILL.md) | Audit whether developer documentation, REST/GraphQL API references, SDK guides, and OpenAPI schemas are machine-readable, server-rendered, and indexable for AI coding assistants. |
...
| [`international-seo-hreflang-audit`](skills/ai-visibility/international-seo-hreflang-audit/SKILL.md) | Audit whether multi-region, multilingual, and localized website implementations correctly declare hreflang annotations, x-default fallbacks, language codes, and canonical relationships. |
...
| [`paywall-access-audit`](skills/ai-visibility/paywall-access-audit/SKILL.md) | Audit whether paywalled, metered, and subscription-gated publications follow Schema.org paywall specifications, provide crawlable lead-in snippets, and configure AI crawler policies. |
