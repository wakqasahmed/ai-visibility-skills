#!/usr/bin/env python3
"""Gated, credentialed model-harness layer for image-audit.
...
def build_enabled_system_prompt() -> str:
    ...
    return (
        ...
        "to (not an image-visibility audit request, wrong skill's job, a vague ask "
        "with no concrete page to check, or a request this skill should refuse per "
