...
# and concrete crawler/schema claims often live in a skill's references/*.md (checks.md,
# scoring_rubric.md, agent_remediation_blueprints.md, ...) rather than its SKILL.md, so
# every reference doc is scanned alongside SKILL.md for citations.
